...
public class PurchaseEntity {
    ...
    public PurchaseEntity(Integer purchaseId, String transactionId, String vendorName,
            String materialCategoryId, String materialTypeId, String brandName,
            String unitId, Integer quantity, Double purchaseAmount,
    ...
    public String toString() {
        return "PurchaseEntity [purchaseId=" + purchaseId + ", transactionId=" + transactionId + "]";
    }
}
